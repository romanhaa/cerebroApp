...
Using the `SingleR` package, we can get a suggestion of cell type for each cell.
...
# Calculate relationship trees (optional)

Here, we calculate phylogenetic trees that represent the similarity between different subgroups, i.e. clusters and cell types.
...
Another interesting perspective is to look at the 100 most expressed genes in every cluster and cell type.
...
Marker genes are genes which are particularly strongly or weakly expressed in a given cell population, e.g. cluster
