---
title: "Introduction to the Cerebro interface (v1.3)"
author: "Roman Hillje"
...
output:
  html_document:
    ...
    mode: selfcontained
vignette: >
  %\VignetteIndexEntry{Introduction to the Cerebro interface (v1.3)}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

# Introduction to the Cerebro v1.3 user interface

Since the last version of Cerebro (`vignette("Cerebro_interface_v1.2")`), enough things in the user interface have changed to do write a new introduction to the user interface.
...
After loading the data set, there is not much more to do here so let's move on to the "Overview" panel.

# Overview

<a target="_blank" href="Cerebro_interface_v1.3_files/"><img src="Cerebro_interface_v1.3_files/" alt="t-SNE projection with cells colored by sample" width="49%" height="auto" /></a>
<a target="_blank" href="Cerebro_interface_v1.3_files/"><img src="Cerebro_interface_v1.3_files/" alt="UMAP projection with cells colored by cell cycle" width="49%" height="auto" /></a>

In the "Overview" tab, you have access to all the dimensional reductions (e.g. t-SNE or UMAP) that have been generated for this data set.
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_03.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_03.png" alt="Composition of samples by cluster" width="49%" height="auto" /></a><a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_04.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_04.png" alt="Distribution of cell cycle states by sample" width="49%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_05.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_05.png" alt="Cluster tree" width="49%" height="auto" /></a><a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_06.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_06.png" alt="Number of transcripts and expressed genes by cluster" width="49%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_07.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_07.png" alt="Table of most expressed by sample and cluster" width="100%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_08.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_08.png" alt="Table of marker genes by sample and cluster" width="100%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_09.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_09.png" alt="Table of enriched pathways in marker genes of samples and clusters" width="100%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_10.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_10.png" alt="Expression of individual genes in t-SNE projection" width="49%" height="auto" /></a><a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_11.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_11.png" alt="Expression of individual genes by sample and cluster" width="49%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_12.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_12.png" alt="Expression of MSigDB gene sets in t-SNE projection" width="49%" height="auto" /><a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_13.png"></a><img src="Cerebro_interface_v1.3_files/2019-09-23_13.png" alt="Expression of MSigDB gene sets by sample and cluster and average expression of 50 most expressed genes in gene set" width="49%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_14.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_14.png" alt="Monocle trajectory - dimensional reduction" width="33%" height="auto" /></a><a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_15.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_15.png" alt="Monocle trajectory - distribution of states along pseudotime" width="33%" height="auto" /></a><a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_16.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_16.png" alt="Monocle trajectory - distribution of states by cluster and cell cycle" width="33%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_17.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_17.png" alt="Gene ID conversion table" width="100%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_18.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_18.png" alt="Information about analysis" width="100%" height="auto" /></a>
...
<a target="_blank" href="Cerebro_interface_v1.3_files/2019-09-23_19.png"><img src="Cerebro_interface_v1.3_files/2019-09-23_19.png" alt="About Cerebro" width="100%" height="auto" /></a>
