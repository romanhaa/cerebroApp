...
```{r eval=FALSE}
dir.create('~/test_cerebro_shinyapps')
dir.create('~/test_cerebro_shinyapps/shiny')

file.copy(
  system.file('extdata', package = 'cerebroApp'),
  '~/test_cerebro_shinyapps/',
  recursive = TRUE
)

unlink(
  c('~/test_cerebro_shinyapps/extdata/v1.0',
    '~/test_cerebro_shinyapps/extdata/v1.1',
    '~/test_cerebro_shinyapps/extdata/v1.2'),
  recursive = TRUE
)

file.copy(
  system.file('shiny', 'v1.3', package = 'cerebroApp'),
  '~/test_cerebro_shinyapps/shiny',
  recursive = TRUE
)
```
...
rsconnect::deployApp('~/test_cerebro_shinyapps/', appName = 'Cerebro v1.3')
```
